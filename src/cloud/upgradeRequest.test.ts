...
describe('upgradeRequest', () => {
  ...
  it('converts field names to camel case', () => {
    const request = upgradeRequest(
      ...
      getBlockOperation as unknown as UnknownOperation,
    );
  ...
  it('does not convert to camel case field names of passed objects', () => {
    const request = upgradeRequest(
      ...
      runContractFunctionOperation as unknown as UnknownOperation,
    );
  ...
  it('removes address and chain if not supported', () => {
    const request = upgradeRequest(
      ...
      resolveDomainOperation as unknown as UnknownOperation,
    );
  ...
  it('keeps address and chain if supported', () => {
    const request = upgradeRequest(
      ...
      getNativeBalanceOperation as unknown as UnknownOperation,
    );
